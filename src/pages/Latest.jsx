...
export default function Latest() {
  const newReleases = [
    { id: 1, title: 'The Last Horizon', date: 'New Today' },
    { id: 2, title: 'Cyber Pulse', date: 'Coming This Friday' },
    { id: 3, title: 'Shadow Realm', date: 'New Season' },
    { id: 4, title: 'Echoes of Time', date: 'Coming Next Week' },
  ];
        ...
        {newReleases.map((item) => (
          <Col key={item.id} xs={12} sm={6} md={3}>
            <Card className="bg-dark text-white border-secondary h-100">
              <Card.Img variant="top" src={`https://picsum.photos/seed/latest${item.id}/300/200`} />
              <Card.Body>
